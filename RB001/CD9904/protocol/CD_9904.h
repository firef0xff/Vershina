...
//константы
	...
	class Data
	{
		...
		private:
			 ...
			 CD_Time *time_1; //время испытания 1 байт -часы ст байт 2 байт часы мл байт 3 байт минуты
			 CD_Time *time_2; //время испытания 1 байт -часы ст байт 2 байт часы мл байт 3 байт минуты
