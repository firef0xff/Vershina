...
bool *ControlLateralA = &bGr1[12];
// M02.3 вкл/выкл контроля бокового разрыва поз А
bool *ControlLateralB = &bGr1[13];
// M03.3 вкл/выкл контроля бокового разрыва поз Б
...
float *max_load_2 = &fGr1[8];
// DB10,REAL154 Корекция диапазона 10-20 по заданию нагрузки 1
...
bool *OverLoad1 = &bGr1[37];
// DB10,X38.5 A Превышение нагрузки на шаге на стороне 1
bool *OverLoad2 = &bGr1[38];
// DB10,X38.6 B Превышение нагрузки на шаге на стороне 2
...
int *next_step_time1 = &iDB20[7];
// DB20,DINT148 номер следующего шага опроса по времени 1
int *next_step_time2 = &iDB20[8];
// DB20,DINT152 номер следующего шага опроса по времени 1
int *next_step_change1 = &iDB20[9];
// DB20,DINT180 номер следующего рабочего шага 1
int *next_step_change2 = &iDB20[10];
// DB20,DINT184 номер следующего рабочего шага 2
// адреса переменных в контроллере
wchar_t *Gr1ItemsNme[GR1ITEMSNUM] =
{L"S7:[S7 connection_4]MX2.1", L"S7:[S7 connection_4]IX125.3",
   // заменить M125 на I125!!!!!
   L"S7:[S7 connection_4]MX50.1", L"S7:[S7 connection_4]MX3.1",
   L"S7:[S7 connection_4]IX125.7", L"S7:[S7 connection_4]MX50.2",
   // заменить M125 на I125!!!!!
   L"S7:[S7 connection_4]MX50.3", L"S7:[S7 connection_4]MX50.4",
   L"S7:[S7 connection_4]MX50.5", L"S7:[S7 connection_4]MX50.6",
   L"S7:[S7 connection_4]MX2.2", L"S7:[S7 connection_4]MX3.2",
   L"S7:[S7 connection_4]MX2.3", L"S7:[S7 connection_4]MX3.3",
   L"S7:[S7 connection_4]MX34.0", L"S7:[S7 connection_4]MX34.2",
   L"S7:[S7 connection_4]MX34.1", L"S7:[S7 connection_4]MX34.3",
   L"S7:[S7 connection_4]MX34.4", L"S7:[S7 connection_4]MX34.5",
   L"S7:[S7 connection_4]MX34.6",
   //
   L"S7:[S7 connection_4]DB10,X2.0", L"S7:[S7 connection_4]DB10,X2.1",
   L"S7:[S7 connection_4]DB10,X2.2", L"S7:[S7 connection_4]DB10,X2.3",
   L"S7:[S7 connection_4]DB10,X2.4", L"S7:[S7 connection_4]DB10,X2.5",
   L"S7:[S7 connection_4]DB10,X2.6", L"S7:[S7 connection_4]DB10,X3.0",
   L"S7:[S7 connection_4]DB10,X38.0", L"S7:[S7 connection_4]DB10,X38.1",
   L"S7:[S7 connection_4]DB10,X38.2", L"S7:[S7 connection_4]DB10,X38.3",
   L"S7:[S7 connection_4]DB10,X38.4", L"S7:[S7 connection_4]DB10,X39.0",
   L"S7:[S7 connection_4]M0.7", L"S7:[S7 connection_4]M1.7",
   L"S7:[S7 connection_4]DB10,X38.5", L"S7:[S7 connection_4]DB10,X38.6",
   // idb20
   L"S7:[S7 connection_4]DB20,DINT14", L"S7:[S7 connection_4]DB20,DINT26",
   L"S7:[S7 connection_4]DB20,DINT38", L"S7:[S7 connection_4]DB20,DINT42",
   L"S7:[S7 connection_4]DB20,DINT66", L"S7:[S7 connection_4]DB20,DINT78",
   L"S7:[S7 connection_4]DB20,DINT82", L"S7:[S7 connection_4]DB20,DINT148",
   L"S7:[S7 connection_4]DB20,DINT152", L"S7:[S7 connection_4]DB20,DINT180",
   L"S7:[S7 connection_4]DB20,DINT184",
   // fgr1
   L"S7:[S7 connection_4]DB20,REAL100", L"S7:[S7 connection_4]DB10,REAL26",
   L"S7:[S7 connection_4]DB10,REAL62", L"S7:[S7 connection_4]DB10,REAL138",
   L"S7:[S7 connection_4]DB10,REAL174", L"S7:[S7 connection_4]DB10,REAL142",
   L"S7:[S7 connection_4]DB10,REAL146", L"S7:[S7 connection_4]DB10,REAL150",
   L"S7:[S7 connection_4]DB10,REAL154", L"S7:[S7 connection_4]DB10,REAL158",
   L"S7:[S7 connection_4]DB10,REAL162", L"S7:[S7 connection_4]DB10,REAL166",
