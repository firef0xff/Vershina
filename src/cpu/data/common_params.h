...
public:
   ...
   bool &OlinSide       = mBoolData[5]; // M34.7 если бит установлен нужно вывести температуру стороны Б
...
private:
   ...
   enum
   {
      BOOL_COUNT  = 6,    // количество булевых переменных
